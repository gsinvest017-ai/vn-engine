...
- 2026-09-24：**v2.2** `video_out/remaster_v2/anqu_narrated_v2_2.mp4`（555.208 秒、影音長度一致、-17.0 LUFS、TP -3.1 dBTP）：用 ComfyUI H3 重生第三章_00_1、第一章_03_5、第三章_00_7 三段（素面燈籠／無字提示詞，每段 3 seed，OCR＋目測挑選，細節見 `docs/remaster_v2/regen.md`）。抽幀確認燈籠特寫無字、神龕段無紅聯假字。v1／v2／v2.1／v2.2 全部保留並列在審片頁。

## 已知限制（未解）
- 第一章_03_5（約 4:14–4:21）香爐右半有一塊柔焦補修痕跡；該段比下一段亮（57 對 39，組裝時曝光匹配已拉近）。
- 第三章_00_7 結尾燈籠熄滅（約 9:05）有 0.5 秒極暗畫面，曝光匹配抬亮後帶顆粒。
- 發音與畫面只經過機器驗證（三套 ASR、聲調分類器、OCR）與抽幀，**尚未人耳試聽、完整播放**；「檔案」的「檔」機器判 2 聲／3 聲不穩（確定不是大陸 4 聲）。請在審片頁 `http://gs.video-factory.com/review/` 審查。
- 其他換字仍有少數極小殘影（各批報告的 unresolved，見 `docs/remaster_v2/hanzi.md`）。
